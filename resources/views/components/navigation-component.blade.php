                    ...
                    <div class="flex justify-between">
                        ...
                        <div  class="pt-2">
                            <ul class="animate__animated hidden row gap-5 lg:flex" id="mainNavigationItems">
                                <li class="animate__animated cursor-pointer transition-colors duration-200 ease-in hover:text-blue-400 font-normal text-sm {{ $active == 'home' ? ' text-blue-300' : ''  }}"><a href="/">HOME</a></li>
                                <li class="animate__animated cursor-pointer transition-colors duration-200 ease-in hover:text-blue-400 font-normal text-sm {{ $active == 'about-us' ? ' text-blue-300' : ''  }}"><a href="/about-us">ABOUT US</a></li>
                                <li class="animate__animated cursor-pointer transition-colors duration-200 ease-in hover:text-blue-400 font-normal text-sm {{ $active == 'services' ? ' text-blue-300' : ''  }}"><a href="/services">SERVICES</a></li>
                            </ul>
                            <div>
